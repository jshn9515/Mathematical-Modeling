...
plt.text(x3 - 2, float(y3), r'$\it{x}$', fontsize=18)
plt.text(x4 + 1, float(y4), r'$\it{y}$', fontsize=18)
style = patches.ArrowStyle('->', head_length=1.2, head_width=0.8)
plt.annotate('', xy=(x4 - 2, float(y4)), xytext=(float(x3 + 2), float(y3)), arrowprops=dict(arrowstyle=style, linewidth=1.5))
